		...
		try {
			...
			do {
				...
				((GetItemsContext)_localctx).v = valParen();
				 items.put(((GetItemsContext)_localctx).i.value, new Przedmiot(((GetItemsContext)_localctx).i.value, ((GetItemsContext)_localctx).v.value)); 
				setState(40);
				_errHandler.sync(this);
				_la = _input.LA(1);
				while (_la==T__4) {
		...
		try {
			...
			do {
				...
				((GetValuesContext)_localctx).v = val();
				 Przedmiot kItem1 = (Przedmiot)items.get(((GetValuesContext)_localctx).i.value); kItem1.baseVal=((GetValuesContext)_localctx).v.value; 
				setState(62);
				_errHandler.sync(this);
				_la = _input.LA(1);
				while (_la==T__7) {
					...
					((GetValuesContext)_localctx).o = val();
					 Przedmiot kItem2 = (Przedmiot)items.get(((GetValuesContext)_localctx).i.value); kItem2.newValReqItems=(((GetValuesContext)_localctx).j1.list); kItem2.newVal=((GetValuesContext)_localctx).v.value; kItem2.baseVal=((GetValuesContext)_localctx).o.value; 
					}
					}
					setState(64);
					_errHandler.sync(this);
				...
				while (_la==T__4) {
					...
					setState(69);
					((GetValuesContext)_localctx).v = val();
					 Przedmiot kItem3 = (Przedmiot)items.get(((GetValuesContext)_localctx).i.value); kItem3.baseVal=((GetValuesContext)_localctx).v.value; 
					setState(79);
					_errHandler.sync(this);
					_la = _input.LA(1);
					while (_la==T__7) {
						...
						setState(74);
						((GetValuesContext)_localctx).o = val();
						 Przedmiot kItem4 = (Przedmiot)items.get(((GetValuesContext)_localctx).i.value); kItem4.newValReqItems=(((GetValuesContext)_localctx).j2.list); kItem4.newVal=((GetValuesContext)_localctx).v.value; kItem4.baseVal=((GetValuesContext)_localctx).o.value; 
						}
						}
						setState(81);
						_errHandler.sync(this);
